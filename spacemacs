  ...
  (setq-default
   ...
   '(
     ...
     (shell :variables
             ...
             shell-default-shell 'shell-pop-ansi-term)
     ;; markdown
     ;; spell-checking
     ;; syntax-checking
     ;; version-control
